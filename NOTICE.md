...
| VFX-JS (`@vfx-js/core` 1.1.0) | [amagi.dev/vfx-js](https://github.com/fand/vfx-js), `pixelateTransition` preset used by the media reveal adapter | MIT License; package is consumed through npm without copying its source into this repository |
