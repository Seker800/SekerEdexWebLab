...
/** Screenshot-time samples from the upstream Smoothie charts, replayed deterministically. */
export const canonicalNetworkTraces = {
  outbound: "0,98 13,90 27,78 35,81 49,92 58,93 72,93 84,99 96,96 106,96 112,97 124,97 136,97 156,97 167,93 181,93 192,99 204,101 216,100 228,97 238,95 253,97 259,98 273,98 280,96",
  inbound: "0,116 3,115 12,138 24,183 36,171 48,147 60,141 72,132 83,99 94,112 110,109 112,109 134,109 144,105 155,107 168,121 180,116 192,104 206,114 216,107 227,107 234,110 251,109 262,102 276,102 280,112"
} as const;
